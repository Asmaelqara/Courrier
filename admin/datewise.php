...
$query=mysqli_query($con,"select * from tbl_courier where statut='Arrivé' and cuid=$userid ORDER BY cid DESC");
//echo $office;
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <h1 align="center"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Liste des courriers arrivés</h1>
                <p></p>
...
<?php 
include 'dbcon.php';
$sql = $conn ->prepare("SELECT COUNT(cid) as m FROM tbl_courier WHERE statut ='Arrivé'  and cuid=$userid");
                                           $sql -> execute();
                                           $count = $sql->fetchAll(); 
			...
			<div class="col-md-9">
					<div class="panel panel-default">
					  <div class="panel-heading main-color-bg">
						<h3 class="panel-title">Vous avez reçus [<?php echo $field['m'];?>] Courriers </h3>
					  </div>
