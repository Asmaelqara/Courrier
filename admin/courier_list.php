...
$query=mysqli_query($con,"select * from tbl_courier ORDER BY cid DESC");
//echo $office;
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <h1 align="center"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Liste des courriers</h1>
                <p></p>
...
<div class="col-md-12">
                    <div class="panel panel-default">
                      <div class="panel-heading main-color-bg">
						...
						<!-- Table -->
						  <table class="table table-striped table-hover" style="margin-top:30px;" name="datatable">
							<tr>
								<td><strong>N_Ordre</strong></td>
	...
	<script src="vendor/jquery/excellentexport.js"></script>
