...
$query = "INSERT INTO tbl_courier (cuid,Date,Nom,Tel,Adresse,Email,Fax,MarsaMaroc,Objet,Statut,Commentaire,Outil,Entité,Instruction)
VALUES('$userID','$Packupdate','$Shippername', '$Shipperphone','$Shipperaddress','$Email','$Fax','$Receivername','$objet' ,'$Statut', '$Comments','$Outil','$Entité','$instructions')";
