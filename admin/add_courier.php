    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <h1 align="center"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Ajouter les courriers reçus</h1>
                <p></p>
			...
			<div class="col-md-9">
					<div class="panel panel-default">
					  ...
					  <div class="panel-body">
					  	<form action="senddata.php" method="post" name="frmShipment"  align="Left"> 
							...
							<div class="form-group">
							  <label>Commentaire :</label>
								...
								<input class="btn btn-info" type="hidden" name="msg" value="Courier yanyu ubu iroherejwe kuri">
							</div>
<div class="form-group">						  
           <label>Courrier :</label>
           <br/>
           <br/>
           <input type="file" name="add_pdf" id="addPdf" value="Ajouter un pdf" required>
           <br/>
           </div>
							<div id="page-content-wrapper">
